...
public class DaoAutoConfiguration implements EnvironmentAware{
    ...
    public SqlSessionFactory sqlSessionFactory() {
        ...
        sqlSessionFactoryBean.setDataSource(dataSource());//放入dataSource

        try {
            ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
            //与mapper.java不在同一包中，故指定mapper.xml位置
    ...
    public static MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        String[] basePackages = new String[] {"com.sgai.meter.transmission.**.mapper",
        		"com.sgmart.upload.mapper",
        		"com.sgmart.auth.user.**.mapper",
        		"com.sgmart.company.mapper",
        		"com.sgmart.code.mapper"
        };
